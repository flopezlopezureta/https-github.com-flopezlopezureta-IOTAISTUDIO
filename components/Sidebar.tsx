...
const Sidebar: React.FC<SidebarProps> = ({ currentView, userRole, companyId, onViewChange, isOpen, onClose, onLogout }) => {
  ...
  const getMenuItems = () => {
    const items = [
      ...
      { id: 'custom-dashboard', label: 'Panel Personalizado', icon: 'M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z' },
    ...
    // Ítem de Documentación disponible para todos
    items.push({ id: 'docs', label: 'Documentación API', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' });
